...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" data-kt-redirect="categories.html">
                <!--begin::Aside column-->
                @csrf
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <a href="javascript:void(0);" class="add_button" title="Add field">
                                ...
                                <input type="text" name="variation[]" class="form-control p-2" value=""/>
                            </a>
                            </div>
