...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-select2-id="select2-data-kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post" data-select2-id="select2-data-kt_post">
        ...
        <div id="kt_content_container" class="container-xxl" data-select2-id="select2-data-kt_content_container">
            <!--begin::Form-->
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework " data-kt-redirect="products.html" >
                @csrf
                <!--begin::Aside column-->
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Label-->
                            <!--begin::Select2-->
                            <select class="form-select mb-2 select2-hidden-accessible" name="category_id" id="category-select" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="" tabindex="-1" aria-hidden="true">
                                <option></option>
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <textarea name="description" class="form-control" id="" cols="10" rows="5" placeholder="description"></textarea>
                                        <br>

                                        <label class="form-label">Tags</label>
                                        <!--end::Label-->
                                        <!--begin::Editor-->
                                        <input name='tags' value='' class="form-control p-2">
                                        {{-- <div>
                                            <!--begin::Label-->
                                            <label class="form-label">Description</label>
                                            <!--end::Label-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-3 row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="price" id="price" class="form-control mb-2" placeholder="Product price" >
                                            </div>

                                            <div style="width: 25%" class="mb-2">
                                            <label class="required form-label ">Discount %</label>
                                            <input type="text" name="discount" id="discount" class="form-control mb-2" placeholder="Discount Percentage" >
                                            </div>
                                            <div style="width: 25%" class="mb-2">
                                            <label class="required form-label ">Discounted Price</label>
                                            <input type="text" id="discounted_price" name="discounted_price" readonly class="form-control mb-2" placeholder="Discounted Price" >
                                            </div>
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                                <input type="number" name="quantity" class="form-control mb-2" placeholder="Add quantity">
                                            </div>
                                            <div style="width: 50%">
                                            <label class="required form-label">Coupon</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                                <input type="number" name="coupon" class="form-control mb-2" placeholder="Add coupon">
                                            </div>
                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        ...
                                        <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div class="col-6">
                                                        <input name='variation' placeholder="Variation" value='' class="form-control p-2">
